...
\begin{remark}[Diffusion Models Learn Data Manifolds]
    ...
    the unconditional diffusion prior acts as a regularization to encourage optimisation of $f$ over
...
regularization may be viewed as dynamically flattening the optimisation landscape for each particle
