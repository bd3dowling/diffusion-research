...
\begin{table}[ht]
    ...
    \caption{Un-normalised scores for SuperConductor experiment}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
      ...
      \caption{GMM Prior samples generated under DDPM with analytic score; $d_x = 8, d_y = 2$.}
      \label{fig:gmm-prior}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
...
\paragraph{Branin Optimization} We train a noise estimating neural network and then employ
