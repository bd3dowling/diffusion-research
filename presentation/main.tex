...
\begin{document}
    ...
    \begin{frame}{Branin Experiment --- Pitfalls of Gradient Optimisation}
        \centering
        \animategraphics[loop,width=10cm]{15}{assets/branin-adam/branin-adam-}{0}{39}
    \end{frame}

    \begin{frame}{Branin Experiment --- Pitfalls of Gradient Optimisation II}
        \centering
        \animategraphics[loop,width=10cm]{15}{assets/branin-adam-larger/branin-adam-larger-}{0}{100}
    \end{frame}

    \begin{frame}{Branin Experiment --- Forwards Noising Process}
        \centering
        \animategraphics[loop,width=10cm]{25}{assets/branin-forward/branin-forward-}{0}{200}
    \end{frame}

    \begin{frame}{Branin Experiment --- Learned De-Noising Process}
        \centering
        \animategraphics[loop,width=10cm]{25}{assets/branin-backwards/branin-backwards-}{0}{200}
    \end{frame}

    \begin{frame}{Branin Experiment --- \texttt{SMCDiffOpt}}
        \centering
        \animategraphics[loop,width=10cm]{25}{assets/branin-particles/branin-particles-}{0}{200}
    \end{frame}

    \begin{frame}{Branin Experiment --- \texttt{SMCDiffOpt} Landscape}
        \centering
        \animategraphics[loop,width=10cm]{25}{assets/branin-particles-dynamic/branin-particles-dynamic-}{0}{100}
    \end{frame}
